...
export function TopBar({
  ...
  return (
    <header
      className="flex items-center justify-between px-2 sm:px-6 py-2 sm:py-4 border-b border-zinc-800/50 bg-black/20 backdrop-blur-sm"
      role="banner"
    >
      {/* Left side */}
      <div className="flex items-center gap-1 sm:gap-4">
        ...
        <div
          className="size-8 sm:size-10 rounded-lg sm:rounded-xl bg-zinc-800 border border-zinc-700/80 grid place-items-center text-xs font-black text-emerald-400 shadow-inner"
          aria-hidden="true"
        >
          AA
        </div>
      ...
      <div className="flex items-center gap-1 sm:gap-3">
        ...
        <Button
          ...
          rightIcon={<ChevronDown className="size-3 sm:size-4 opacity-70" />}
