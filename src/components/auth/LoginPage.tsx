...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-md p-8 border-primary-400/30 bg-background/90 backdrop-blur-xl shadow-2xl shadow-primary-500/20">
        <div className="flex flex-col items-center gap-6">
          {/* Logo/Header */}
          <div className="flex flex-col items-center gap-2">
            <div className="size-24 rounded-[var(--radius-2xl)] bg-primary-500/15 border border-primary-400/30 flex items-center justify-center shadow-inner overflow-hidden text-2xl font-black text-black">
              AA
            </div>
            <h1 className="text-4xl font-black tracking-tighter text-foreground uppercase mt-4 italic">
              Aussie <span className="text-primary-400">Agents</span>
            </h1>
            <p className="text-[10px] text-foreground/40 font-black uppercase tracking-[0.2em] -mt-1">
          ...
          <p className="text-xs text-foreground/30 font-medium uppercase tracking-widest mt-4">
